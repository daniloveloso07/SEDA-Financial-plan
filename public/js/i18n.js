...
const TRANSLATIONS = {
    "en": {
        ...
        "form": {
            ...
            "welcome_4": "During your 6 months with the project, you will be entitled to several exclusive benefits for SEDA students.",
            "start_btn": "Start!",
            "name_question": "I'd like to call you by your name from now on. What is your name?",
            "lets_go": "Perfect, {{name}}!",
            "phone_question": "Now please give me your WhatsApp, so our team can contact you if we decide to proceed with the process.",
            "email_question": "Email Address",
            "birthdate_question": "Now tell me your date of birth.",
            "id_question": "To validate your credit score we need your ID/CPF number.",
            "country_question": "Now tell me, which country are you from? If your country is not listed below, unfortunately this payment method is not yet available for you.",
            "address_street_question": "Thank you very much, now I need to know exactly your address. Can you start by telling me the name of your street and house number please?",
            "address_city_question": "And what is your city?",
            "address_state_question": "And now your State/Province?",
            "address_postal_question": "And finally your Postal Code?",
            "occupation_question": "Perfect, we're almost finished with your part. Now tell me, what is your profession?",
            "income_question": "And tell me, what is your monthly income?",
            "travel_date_question": "And finally, when do you plan to travel? If you don't have an exact date, no problem, you can put an approximate date.",
            "guarantor_intro": "Perfect! We've finished your part and now we're moving on to your guarantor or financial responsible person. You cannot use your own information here. We need it to be someone who will guarantee your application.",
            "guarantor_name_question": "What is your guarantor's name?",
            "guarantor_email_question": "And what is their email?",
            "guarantor_phone_question": "What is their contact phone number?",
            "guarantor_birthdate_question": "Now I need your guarantor's date of birth.",
            "guarantor_id_question": "What is their ID/CPF number?",
            "guarantor_street_question": "What is your guarantor's street name and number?",
            "guarantor_city_question": "What is the guarantor's city?",
            "guarantor_state_question": "And the State/Province?",
            "guarantor_postal_question": "And the Postal Code?",
            "guarantor_occupation_question": "What does your guarantor work as?",
            "guarantor_relationship_question": "What is your relationship with them?",
            "guarantor_income_question": "What is your guarantor's monthly income?",
            "privacy_consent_question": "Now I just need you to authorize me to share this information with our evaluation bot. For that, tell me if you agree to the processing of your personal data.",
            "privacy_agree_btn": "I agree"
        },
        "result": {
    ...
    "pt": {
        ...
        "form": {
            ...
            "welcome_2": "Antes de começarmos, tenho um aviso importante pra te dar! O preenchimento deste formulario não garante que o seu financiamento será pré aprovado.",
            ...
            "welcome_4": "Durante seus 6 meses do projeto, você terá direito a vários benefícios exclusivos para alunos SEDA.",
            "start_btn": "Começar!",
            "name_question": "Gostaria de te chamar pelo nome a partir de agora. Como você se chama?",
            "lets_go": "Perfeito, {{name}}!",
            "next": "Enviar",
            "phone_question": "Agora me passa o seu WhatsApp, pra que a nossa equipe possa entrar em contato caso a gente decida seguir com o processo.",
            "email_question": "Endereço de Email",
            "birthdate_question": "Agora me fala a sua data de nascimento.",
            "id_question": "Para validar o seu score de credito precisamos do seu CPF.",
            "country_question": "Agora fala pra mim de qual país você é? Se o seu país não estiver lista abaixo infelizmente essa modalidade de pagamento ainda nao esta disponivel para voce.",
            "address_street_question": "Muito obrigado, agora eu preciso saber exatamente o seu endereço. Pode começar me dizendo o nome da sua rua com o numero da sua residencia por favor?",
            "address_city_question": "E qual a sua cidade?",
            "address_state_question": "E agora o seu Estado?",
            "address_postal_question": "E para finalizar o seu CEP?",
            "occupation_question": "Perfeito, estamos quase acabando a sua parte. Me conta agora qual a sua profissão?",
            "income_question": "E me diz, qual a sua renda mensal?",
            "travel_date_question": "E por ultimo, quando você pretende embarcar? Se não tiver uma data exata nao tem problema pode colocar a data aproximada.",
            "guarantor_intro": "Perfeito! Terminamos a sua parte e agora vamos para o seu fiador ou responsavel financeiro, é aquele pessoa que garante que se você não pagar ela paga 😂. Ah, você não pode colocar seus próprios dados aqui. Precisamos que seja realmente uma pessoa que garantirá a sua aplicação.",
            "guarantor_name_question": "Qual o nome do seu fiador?",
            "guarantor_email_question": "E qual o e-mail dele?",
            "guarantor_phone_question": "Qual o telefone de contato?",
            "guarantor_birthdate_question": "Agora eu preciso da data de nascimento do seu fiador.",
            "guarantor_id_question": "Qual o CPF?",
            "guarantor_address_question": "E o endereço completo do seu fiador?",
            "guarantor_street_question": "Qual o nome da rua e número da residência do seu fiador?",
            "guarantor_city_question": "Qual a cidade do fiador?",
            "guarantor_state_question": "E o Estado?",
            "guarantor_postal_question": "E o CEP?",
            "guarantor_occupation_question": "Com o que o seu fiador trabalha?",
            "guarantor_relationship_question": "Qual a sua relação com ele (a)?",
            "guarantor_income_question": "Qual a renda mensal do seu Fiador?",
            "privacy_consent_question": "Agora eu só preciso que você me autorize a compartilhar essas informações com nosso robozinho de avaliação. Para isso me diz se você concorda com o processamento dos seus dados pessoais.",
            "privacy_agree_btn": "Estou de acordo"
        },
        "result": {
    ...
    "es": {
        ...
        "form": {
            ...
            "welcome_4": "Durante tus 6 meses del proyecto, tendrás derecho a varios beneficios exclusivos para alumnos SEDA.",
            "start_btn": "¡Comenzar!",
            "name_question": "Me gustaría llamarte por tu nombre a partir de ahora. ¿Cómo te llamas?",
            "lets_go": "¡Perfecto, {{name}}!",
            "next": "Enviar",
            "phone_question": "Ahora pásame tu WhatsApp, para que nuestro equipo pueda contactarte si decidimos seguir con el proceso.",
            "email_question": "Dirección de Correo Electrónico",
            "birthdate_question": "Ahora dime tu fecha de nacimiento.",
            "id_question": "Para validar tu puntaje de crédito necesitamos tu número de Identidad/DNI.",
            "country_question": "Ahora dime, ¿de qué país eres? Si tu país no está en la lista a continuación, lamentablemente esta modalidad de pago aún no está disponible para ti.",
            "address_street_question": "Muchas gracias, ahora necesito saber exactamente tu dirección. ¿Puedes empezar diciéndome el nombre de tu calle con el número de tu residencia por favor?",
            "address_city_question": "¿Y cuál es tu ciudad?",
            "address_state_question": "¿Y ahora tu Estado/Provincia?",
            "address_postal_question": "¿Y para finalizar tu Código Postal?",
            "occupation_question": "Perfecto, ya casi terminamos con tu parte. Cuéntame ahora, ¿cuál es tu profesión?",
            "income_question": "Y dime, ¿cuál es tu ingreso mensual?",
            "travel_date_question": "Y por último, ¿cuándo pretendes viajar? Si no tienes una fecha exacta no hay problema, puedes poner la fecha aproximada.",
            "guarantor_intro": "¡Perfecto! Terminamos tu parte y ahora vamos con tu garante o responsable financiero. No puedes usar tus propios datos aquí. Necesitamos que sea realmente una persona que garantice tu solicitud.",
            "guarantor_name_question": "¿Cuál es el nombre de tu garante?",
            "guarantor_email_question": "¿Y cuál es su correo electrónico?",
            "guarantor_phone_question": "¿Cuál es su teléfono de contacto?",
            "guarantor_birthdate_question": "Ahora necesito la fecha de nacimiento de tu garante.",
            "guarantor_id_question": "¿Cuál es su número de Identidad/DNI?",
            "guarantor_street_question": "¿Cuál es el nombre de la calle y el número de la residencia de tu garante?",
            "guarantor_city_question": "¿Cuál es la ciudad del garante?",
            "guarantor_state_question": "¿Y el Estado/Provincia?",
            "guarantor_postal_question": "¿Y el Código Postal?",
            "guarantor_occupation_question": "¿En qué trabaja tu garante?",
            "guarantor_relationship_question": "¿Cuál es tu relación con él/ella?",
            "guarantor_income_question": "¿Cuál es el ingreso mensual de tu garante?",
            "privacy_consent_question": "Ahora solo necesito que me autorices a compartir esta información con nuestro robot de evaluación. Para ello, dime si estas de acuerdo con el procesamiento de tus datos personales.",
            "privacy_agree_btn": "Estoy de acuerdo"
        },
        "result": {
